...
def main():
    ...
    for i in range(0, len(method)):
        ...
        flag , noflag, framepoints, P_3d_plan =Calib.ProjectorCalibrate()
        ...
        plot_reprojection(flag[0][5], flag[0][4],"OpenCV Flag, {} ".format(method[i]))
        plot_reprojection(noflag[0][5], noflag[0][4],"No OpenCv Flag, {}".format(method[i]))
